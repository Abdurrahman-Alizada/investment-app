...
const EnterName = ({route, navigation}) => {
  ...
  const {phone, country, email} = route.params; // Phone number from previous screen
  ...
  const handleNext = () => {
    ...
    navigation.navigate('EnterPassword', {phone, email, country, name});
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View
        ...
        <CustomHeaderText title="Whats your good name?" />
        <Text
          style={{
            color: 'gray',
            marginBottom: 20,
          }}>
          Please enter your name to continue. After entering it, you can move
